	...
	<section class="content">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title">
					<a href="${request.contextPath}/subject/create"
						class="btn btn-sm btn-dark"><i class="fa fa-plus-circle"></i></a>
				</h3>

				<div class="card-tools">
					<form id="form-search" action="${request.contextPath}/subject/search" method="get">
						...
						<tbody>
							<c:forEach items="${ page.getContent() }" var="s">
								<tr>
									...
									<td>${ s.name }</td>
									<td>
										<fmt:formatDate value="${ s.created }" dateStyle="medium"/>
									</td>
									<td class="text-right"><a
										href="${request.contextPath}/subject/${ s.id }/update"
										class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
										<a href="${request.contextPath}/subject/${ s.id }/delete"
