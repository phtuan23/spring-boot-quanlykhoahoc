...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="card">
			...
			<div class="card-body">
				<form:form action="" method="post" modelAttribute="class">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleFormControlInput1">Tên Lớp</label>
								<form:input type="text" class="form-control"
									path="name" placeholder="Tên Lớp" />
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<form:select path="status" class="form-control">
									<form:option value="0">Chưa mở</form:option>
									<form:option value="1">Đã mở</form:option>
								</form:select>
							</div>
